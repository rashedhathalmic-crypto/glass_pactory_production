...
class _State extends State<NcGeneratorScreen> {
  ...
  Widget _setup() => AppCard(title: 'Perimeter grinding settings (G58)', child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [_dropBox(), const SizedBox(height: 16), Row(children: [Expanded(child: _field(_tool, 'Tool number')), const SizedBox(width: 12), Expanded(child: _field(_diameter, 'Tool diameter (D) — full diameter', suffix: 'mm'))]), const SizedBox(height: 12), Row(children: [Expanded(child: _field(_thickness, 'Glass thickness', suffix: 'mm')), const SizedBox(width: 12), Expanded(child: _field(_passes, 'Total passes'))]), const SizedBox(height: 12), Row(children: [Expanded(child: _field(_cutPerPass, 'Cut per pass', suffix: 'mm')), const SizedBox(width: 12), Expanded(child: _field(_program, 'Program number', numeric: false))]), const SizedBox(height: 12), Row(children: [Expanded(child: _field(_x, 'X offset', suffix: 'mm')), const SizedBox(width: 12), Expanded(child: _field(_y, 'Y offset', suffix: 'mm'))]), const SizedBox(height: 12), Row(children: [Expanded(child: _field(_plunge, 'Plunge feed', suffix: 'mm/min')), const SizedBox(width: 12), Expanded(child: _field(_feed, 'Cutting feed', suffix: 'mm/min'))]), const SizedBox(height: 16), FilledButton.icon(onPressed: _document == null ? null : _generate, icon: const Icon(Icons.precision_manufacturing), label: const Text('Generate SKG1625 NC')), if (_error != null) Padding(padding: const EdgeInsets.only(top: 12), child: Text(_error!, style: const TextStyle(color: AppColors.error))), const SizedBox(height: 14), const Text('G58 is fixed. Total passes include semi-finish and final finish. The drawing stays on this device.', style: TextStyle(color: AppColors.textSecondary, fontSize: 12))]));
